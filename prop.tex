...
\begin{table}[H]
    \centering
    \includegraphics[width = 0.7\linewidth]{ptareq}
...
The concept of the swirl injector is pretty simple. Indeed, it's based on a coaxial injection but 
