...
\begin{figure}[H]
	...
	\caption{Final propellant tank design detailed view}\label{fig:detail}
\end{figure}
\begin{figure}[H]
	\centering
...
\end{align}
\clearpage
Those diameters certainly look very large and oversized for our application so we will need to find another way to fit them in. We believe it is possible as the Electron uses a similar kind of electrically driven turbo pump system for their mission although the scale is different. The parts other than the physical dimensioning do seem to make sense though.
